...
impl<F: PrimeField> AHPForR1CS<F> {
    ...
    pub const ALL_COMMITED_POLYNOMIALS: [&'static str; 20] = [
        "a_row",
        "a_col",
        "a_val",
        "b_row",
    ...
    /// The statement oracles
    pub const STMT_POLYS: [&'static str; 2] = ["r", "x"];
    ///The labels for polynomials for which we need to do MPC.
    pub const SECRET_SHARED_POLYNOMIALS: [&'static str; 7] =
        ["w", "z_a", "z_b", "mask_poly", "x", "g_1", "h_1"];
    /// Public label polynomials
    pub const PUBLIC_POLYNOMIALS: [&'static str; 13] = [
        "a_row", "a_col", "a_val", "b_row", "b_col", "b_val", "c_row", "c_col", "c_val", "g_2",
        "h_2", "g_3", "h_3",
    ];

    /// The polynomails which are evaluated at beta2
    pub const BETA2_POLYS: [&'static str; 2] = ["g_2", "h_2"];

    /// The polynomials which are evaluated for beta3
    pub const BETA3_POLYS: [&'static str; 11] = [
        "a_row", "a_col", "a_val", "b_row", "b_col", "b_val", "c_row", "c_col", "c_val", "g_3",
        "h_3",
    ];
